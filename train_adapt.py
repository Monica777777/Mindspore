...
from msadapter.pytorch.utils.data.sampler import Sampler
...
if __name__ == '__main__':
    ...
    elif args.dataset == "coco": # ms-coco
        base_num = 60  # 基类
        if args.phase == 1:
    ...
    if args.cuda:
        fasterRCNN.cuda()
    optimizer = torch.optim.SGD(fasterRCNN.trainable_params(), learning_rate=lr, momentum=cfg.TRAIN.MOMENTUM)
    ...
    for epoch in range(args.start_epoch, args.max_epochs):
        ...
        ms.save_checkpoint(fasterRCNN, save_name)
